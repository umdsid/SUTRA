...
def test_too_few_resolved_configs_cannot_certify_low_flow():
    configs=pd.DataFrame([
        ...
        {"landmark_index":1,"nodes":100,"removed_fraction":.2,"ell":.2,
         ...
         "resolved_blocks":2,"expected_blocks":10,"resolved":False},
        {"landmark_index":1,"nodes":100,"removed_fraction":.2,"ell":.2,
         "stride":3,"width":3,"velocity":None,"acceleration":None,
         "resolved_blocks":2,"expected_blocks":10,"resolved":False},
    ])
    th=pd.DataFrame([
