...
from sutra.constants import VERSION
from sutra.io.discovery import discover_xenium_samples
from sutra.io.xenium import read_10x_h5_metadata, read_cells
from sutra.level0.audit import audit_level0, write_level0_tables
from sutra.provenance.hashing import sha256_file
...
def main(argv=None):
    ...
    for i, sample in enumerate(samples, 1):
        ...
        provenance = {
            "schema_version": "sutra.provenance.v1",
    ...
    summary = {
        "schema_version": "sutra.tranche1.summary.v1",
        "strata_version": VERSION,
