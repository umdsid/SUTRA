...
def main():
    ...
    patterns=[
        ...
        "src/strata_hierarchy/v093/*.py",
        "src/strata_hierarchy/v094/*.py",
        "src/strata_hierarchy/v0941/*.py",
        "src/strata_hierarchy/v100/*.py",
        "src/strata_hierarchy/v101/*.py",
        "src/strata_hierarchy/v102/*.py",
        "src/strata_hierarchy/v103/*.py",
        "src/strata_hierarchy/v104/*.py",
        "src/strata_hierarchy/v105/*.py",
        "src/strata_hierarchy/v106/*.py",
        "src/strata_hierarchy/v1061/*.py",
        "src/strata_hierarchy/v107/*.py",
        "src/strata_hierarchy/v108/*.py",
        "src/strata_hierarchy/v109/*.py",
        "src/strata_hierarchy/v1091/*.py",
        "src/strata_hierarchy/v1092/*.py",
        "src/strata_hierarchy/v1093/*.py",
        "src/strata_hierarchy/v10931/*.py",
    ]
