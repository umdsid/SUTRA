...
from strata_hierarchy import GraphID, SampleID, PatchID, InterfaceID
...
from strata_hierarchy.builders.graph import build_graph
from strata_hierarchy.provenance import Provenance
from strata_hierarchy.sample import Sample
from strata_hierarchy.hashing import sha256_file
...
def one_sample(project_s: str, sample: str, sample_index: int):
    ...
    expression_manifest = {
        "schema_version": "strata.level0.expression_pointer.v1",
